...
export function IconProfile({ color })       { return <NavIcon color={color}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></NavIcon>; }
...
export function IconFeedNav({ color })       { return <NavIcon color={color}><path d="M4 6h16M4 10h10M4 14h12M4 18h8"/></NavIcon>; }
